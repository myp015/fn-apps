...
| fn-aic8800 | v1.0.2 | all | AICSemi/爱科微科技 AIC8800 芯片的 WiFi6 模组驱动，提供对该芯片的网络功能支持。 |
| fn-broadcom-sta | v1.0.2 | all | Broadcom STA 是 BCM4311-、BCM4312-、BCM4313-、BCM4321-、BCM4322-、BCM43142-、BCM43224-、BCM43225-、BCM43227-、BCM43228-、BCM4331-、BCM4360- 和 BCM4352 等 IEEE 802.11a/b/g/n 无线网卡的驱动程序。 |
...
| fn-monitor | v1.0.2 | all | 显示器/电源设置应用，用于配置系统的显示器和电源选选项。 |
| fn-ntfs3 | v1.0.7 | all | ntfs3 驱动是一个用于 Linux 内核的开源 NTFS 文件系统驱动程序，旨在提供对 NTFS 格式化分区的高性能读写支持。 |
...
| fn-scheduler | v1.2.0 | all | 轻量级的任务计划应用，支持设置定时任务以自动执行脚本或命令，同时也支持基于条件的任务触发，例如在特定时间、特定事件或特定文件变化时执行任务。 |
...
| fn-yt6801 | v1.0.2 | all | Motorcomm/裕太微 千兆有线网卡 YT6801 驱动，提供对该芯片的网络功能支持。 |
