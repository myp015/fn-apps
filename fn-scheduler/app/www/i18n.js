export default {
  "zh-CN": {
    ...
    "field.settings.condition_timeout": "条件脚本超时（秒）",
    "field.settings.condition_timeout_hint": "事件触发里的条件脚本检测超时，最小 1 秒。",
  ...
  "en": {
    ...
    "field.settings.condition_timeout": "Condition timeout (seconds)",
    "field.settings.condition_timeout_hint": "Timeout for condition scripts in event triggers; minimum 1 second.",
